# filepath: c:\Users\rober\Desktop\Uni\Bachelor\HCS_App\controllers\sync_controller.py
...
def list_files():
    from models.file import File  # Import File here to avoid circular imports
